...
class Subscription extends \Mollie\Api\Resources\BaseResource
{
    ...
    public function update()
    {
        ...
        $body = \json_encode(["amount" => $this->amount, "times" => $this->times, "startDate" => $this->startDate, "webhookUrl" => $this->webhookUrl, "description" => $this->description, "mandateId" => $this->mandateId, "interval" => $this->interval]);
