...
class StreamWrapper
{
     ...
     */
    public static function getResource(\_PhpScoper5e258eb49a208\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\_PhpScoper5e258eb49a208\Psr\Http\Message\StreamInterface $stream)
    {
