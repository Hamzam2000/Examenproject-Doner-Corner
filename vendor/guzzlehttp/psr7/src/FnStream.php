 ...
 */
class FnStream implements \_PhpScoper5e258eb49a208\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\_PhpScoper5e258eb49a208\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
